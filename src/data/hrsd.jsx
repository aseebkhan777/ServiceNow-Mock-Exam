const HRSD = [
  ...
  },
  {
    ...
    correctAnswers: ["The Admin can no longer add members to HR groups."],
  ...
  },
  {
    ...
    correctAnswers: ["Personal employee data"],
    multipleChoice: false,
  },
  {
    id: 7,
    text: "How many User Criteria Records may be applied to a single KB or KB Article?",
    options: ["Only two", "Only three", "Unlimited"],
    correctAnswers: ["Unlimited"],
    multipleChoice: false,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswers: ["Both are required."],
    multipleChoice: false,
  },
  {
    id: 10,
    text: "In the base instance, what determines the conditions a Case must meet before it can be assigned to an agent?",
    options: ["Matching Rules", "Client Rules", "ACLs", "Escalation Rules"],
    correctAnswers: ["Matching Rules"],
    multipleChoice: false,
  },
  {
    id: 11,
    ...
    correctAnswers: ["HR Basic [sn_hr_core.basic]"],
    multipleChoice: false,
  },
  {
    id: 12,
    ...
    correctAnswers: ["Document Templates", "PDF document templates"],
    multipleChoice: true,
  },
  {
    id: 13,
  ...
  },
  {
    ...
    correctAnswers: ["HRSD - HR Service Delivery"],
    multipleChoice: false,
  },
  {
    id: 15,
    ...
    correctAnswers: ["Client Roles"],
    multipleChoice: false,
  },
  {
    id: 16,
    text: "What kind of records do HR Requests create?",
    options: ["HR Incidents", "HR Files", "HR Problems", "HR Cases"],
    correctAnswers: ["HR Cases"],
    multipleChoice: false,
  },
  {
    id: 17,
    ...
    correctAnswers: ["They require a plugin to be activated first."],
    multipleChoice: false,
  },
  {
    id: 18,
  ...
  },
  {
    ...
    correctAnswers: ["Using HR Criteria"],
    multipleChoice: false,
  },
  {
    id: 20,
  ...
  },
  {
    ...
    correctAnswers: ["Generate HR Profiles"],
    multipleChoice: false,
  },
  {
    id: 23,
    ...
    correctAnswers: ["Platform Access"],
    multipleChoice: false,
  },
  {
    id: 24,
    ...
    correctAnswers: ["Only the assigned to person"],
    multipleChoice: false,
  },
  {
    id: 25,
  ...
  },
  {
    ...
    correctAnswers: ["Full Time Employee", "Temporary Employee", "Contractor"],
    multipleChoice: true,
  },
  {
    id: 27,
  ...
  },
  {
    ...
    correctAnswers: ["Properties", "Lists", "Forms"],
    multipleChoice: true,
  },
  {
    id: 30,
    ...
    correctAnswers: ["processAndGetCandidates"],
    multipleChoice: false,
  },
  {
    id: 31,
  ...
  },
  {
    ...
    correctAnswers: ["Contextual Search configuration"],
    multipleChoice: false,
  },
  {
    id: 33,
    ...
    correctAnswers: ["HR Service, Topic Detail, Topic Category, COE."],
    multipleChoice: false,
  },
  {
    id: 34,
    ...
    correctAnswers: ["read articles, but not contribute"],
    multipleChoice: false,
  },
  {
    id: 35,
    ...
    correctAnswers: ["The HR Template is referenced on the HR Service record."],
    multipleChoice: false,
  },
  {
    id: 36,
  ...
  },
  {
    ...
    options: ["Drastic", "Low", "Major", "Nominal"],
    correctAnswers: ["Drastic"],
    multipleChoice: false,
  },
  {
    id: 38,
    ...
    correctAnswers: ["Metric Result [asmt_metric_result]"],
    multipleChoice: false,
  },
  {
    id: 39,
    ...
    correctAnswers: ["Translated Versions related list"],
    multipleChoice: false,
  },
  {
    id: 40,
    ...
    correctAnswers: ["From Managed Documents"],
    multipleChoice: false,
  },
  {
    id: 41,
    ...
    correctAnswers: ["Profile Reader [sn_hr_core.profile_reader]"],
    multipleChoice: false,
  },
  {
    id: 42,
    ...
    correctAnswers: ["Can/Cannot Read User Criteria"],
    multipleChoice: false,
  },
  {
    id: 43,
  ...
  },
  {
    ...
    correctAnswers: ["Click the Mark as Incomplete button"],
    multipleChoice: false,
  },
  {
    id: 45,
  ...
  },
  {
    ...
    correctAnswers: ["The Mapping field on the PDF Template Mappings record"],
    multipleChoice: false,
  },
  {
    id: 48,
  ...
  },
  {
    ...
    correctAnswers: ["Add it to the Contextual Search configuration"],
    multipleChoice: false,
  },
  {
    id: 50,
    ...
    correctAnswers: ["On the HR service record"],
    multipleChoice: false,
  },
  {
    id: 51,
    ...
    correctAnswers: ["HR Administration > Properties"],
    multipleChoice: false,
  },
  {
    id: 52,
  ...
  },
  {
    ...
    correctAnswers: ["HR Integrations Admin [sn_hr_integrations.admin]"],
    multipleChoice: false,
  },
  {
    id: 55,
    ...
    correctAnswers: ["KB Writer [sn_hr_core.kb_writer]"],
    multipleChoice: false,
  },
  {
    id: 56,
  ...
  },
  {
    ...
    correctAnswers: ["An Assignment Rule assigns the Case to a group"],
    multipleChoice: false,
  },
  {
    id: 62,
    ...
    correctAnswers: ["Manager Dashboard", "Overview", "HR Case Dashboard"],
    multipleChoice: true,
  },
  {
    id: 63,
    ...
    correctAnswers: ["Managed Interactions, Self-Reliance, Smart Services"],
    multipleChoice: false,
  },
  {
    id: 64,
    ...
    options: ["Employment type", "Profile type", "Employee type", "User type"],
    correctAnswers: ["Employment type"],
    multipleChoice: false,
  },
  {
    id: 65,
    text: "What does the employee utilize when submitting a self-service request to the HR Organization?",
    options: ["HR Catalog", "HR Skills", "HR Template", "HR Profile"],
    correctAnswers: ["HR Catalog"],
    multipleChoice: false,
  },
  {
    id: 66,
    ...
    correctAnswers: ["They group common HR Services."],
    multipleChoice: false,
  },
  {
    id: 67,
  ...
  },
  {
    ...
    options: ["Python", "Regex", "sed/awk", "JavaScript"],
  ...
  },
  {
    ...
    correctAnswers: ["Manage HR Skills"],
    multipleChoice: false,
  },
  {
    id: 71,
  ...
  },
  {
    ...
    options: ["All", "Global", "Group", "Personal"],
    correctAnswers: ["All"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    correctAnswers: ["HR Admin [sn_hr_core.admin]"],
    multipleChoice: false,
  },
  {
    id: 76,
  ...
  },
  {
    ...
    correctAnswers: ["HR Service Delivery Professional"],
    multipleChoice: false,
  },
  {
    id: 78,
    ...
    correctAnswers: ["Delegated Developer [delegated_developer]"],
    multipleChoice: false,
  },
  {
    id: 79,
    ...
    correctAnswers: ["It indicates who generated the document"],
    multipleChoice: false,
  },
  {
    id: 80,
  ...
  },
  {
    ...
    options: ["COE", "Topic Detail", "Template", "Record Producer"],
    correctAnswers: ["Record Producer"],
    multipleChoice: false,
  },
  {
    ...
    options: ["Backlog", "Epics", "Products", "Groups"],
    correctAnswers: ["Products"],
    multipleChoice: false,
  },
  {
    id: 83,
  ...
  },
  {
    ...
    correctAnswers: ["HR Case Management"],
    multipleChoice: false,
  },
  {
    id: 85,
    ...
    options: ["Page Editor", "Designer", "Widget Editor", "Branding Editor"],
    correctAnswers: ["Designer"],
    multipleChoice: false,
  },
  {
    id: 86,
    ...
    correctAnswers: ["Survey Designer"],
    multipleChoice: false,
  },
  {
    id: 87,
    ...
    correctAnswers: ["Change Layout", "Add Content"],
    multipleChoice: true,
  },
  {
    id: 88,
    ...
    correctAnswers: ["Schedule field on the Queues record"],
    multipleChoice: false,
  },
  {
    id: 89,
    ...
    correctAnswers: ["Customer's willingness to change"],
    multipleChoice: false,
  },
  {
    id: 90,
  ...
  },
  {
    ...
    correctAnswers: ["EF Admin [sn_hr_ef.admin] role"],
    multipleChoice: false,
  },
  {
    id: 92,
    ...
    correctAnswers: ["No role is needed"],
    multipleChoice: false,
  },
  {
    id: 93,
  ...
  },
  {
    ...
    correctAnswers: ["It means a high score is good"],
    multipleChoice: false,
  },
  {
    id: 95,
    ...
    correctAnswers: ["Human Resources: Lifecycle Events"],
    multipleChoice: false,
  },
  {
    id: 96,
  ...
  },
  {
    ...
    correctAnswers: ["Populate fields on the HR Case record"],
    multipleChoice: false,
  },
  {
    id: 99,
  ...
  },
  {
    ...
    correctAnswers: ["Set Optional to True on the HR Task Template"],
    multipleChoice: false,
  },
  {
    id: 102,
    ...
    correctAnswers: ["Configuration complexity"],
    multipleChoice: false,
  },
  {
    id: 103,
    ...
    correctAnswers: ["COE ACL Configuration"],
    multipleChoice: false,
  },
  {
    id: 104,
    ...
    correctAnswers: ["Create activity containers for the dependent items"],
    multipleChoice: false,
  },
  {
    id: 105,
    text: "What kinds of records can be created using HR Service Activities? (Choose two.)",
    options: ["Workflows", "Approvals", "HR Templates", "Tasks"],
  ...
  },
  {
    ...
    correctAnswers: ["An HR Service is needed to initiate the LE process"],
    multipleChoice: false,
  },
  {
    id: 109,
  ...
  },
  {
    ...
    correctAnswers: ["HR Integration Service"],
    multipleChoice: false,
  },
  {
    id: 111,
  ...
  },
  {
    ...
    correctAnswers: ["HR Case Reader [sn_hr_le.case_reader]"],
    multipleChoice: false,
  },
  {
    id: 117,
    ...
    correctAnswers: ["HR Case Workers. Employees, users in other groups"],
    multipleChoice: false,
  },
  {
    id: 118,
    ...
    correctAnswers: ["HR Outbound Schema Mapping"],
    multipleChoice: false,
  },
  {
    id: 119,
  ...
  },
  {
    ...
    correctAnswers: ["Select the Applies to all services box"],
    multipleChoice: false,
  },
  {
    id: 121,
  ...
  },
  {
    ...
    options: ["Reverse", "Cancel", "Repeal", "Rescind"],
    correctAnswers: ["Rescind"],
    multipleChoice: false,
  },
  {
    id: 124,
    ...
    correctAnswers: ["Activity Field Mapping"],
    multipleChoice: false,
  },
  {
    id: 125,
  ...
  },
  {
    ...
    correctAnswers: ["Customized Variable"],
    multipleChoice: false,
  },
  {
    id: 129,
  ...
  },
  {
    ...
    correctAnswers: ["Employee Center"],
    multipleChoice: false,
  },
  {
    id: 131,
  ...
  },
  {
    ...
    correctAnswers: ["Select the ignore empty date box."],
    multipleChoice: false,
  },
  {
    id: 136,
  ...
  },
  {
    ...
    correctAnswers: ["Proactive Prompts"],
    multipleChoice: false,
  },
  {
    id: 138,
  ...
  },
  {
    ...
    correctAnswer: "Learning Posts",
    multipleChoice: false,
  },
  {
    id: 141,
    text: "After an HRSD implementation, what capabilities exist for a System Administrator attempting to impersonate an HR member once the HR Admin role has been removed? (Choose two.)",
    options: [
      "System Admin can grant scoped HR roles",
      "System Admin can view HR Cases and confidential profile information",
      "System Admin cannot grant scoped HR roles",
      "System Admin cannot view HR Cases and confidential profile information",
    ],
    correctAnswers: [
      "System Admin cannot grant scoped HR roles",
      "System Admin cannot view HR Cases and confidential profile information",
  ...
  {
    id: 142,
    text: "Which base instance application delivers the results of current state metrics?",
    options: [
      "HR Integrations",
      "Employee Center",
  ...
  {
    id: 143,
    text: "When creating a new Lifecycle Event activity set, what happens when the audience field is set as empty?",
    options: [
      "The activity set applies to all employees",
      "The activity set applies for a specific group of people",
      "The activity set will not apply to a specific group of people",
      "The activity set will not apply to any employees",
    ],
    correctAnswer: "The activity set applies to all employees",
    multipleChoice: false,
  },
  {
    id: 144,
  ...
  {
    id: 146,
    text: "What is the role of Trigger conditions in activity sets?",
    options: [
      "It defines specific employees to the activity set targets",
      "It defines when the activity set should be initiated",
      "It defines order number for the activity set",
      "It defines the relationships between fields in various tables",
    ],
    correctAnswer: "It defines when the activity set should be initiated",
    multipleChoice: false,
  },
  {
    id: 147,
    text: "Which ServiceNow feature is used to create pulse surveys?",
    options: [
      "Employee Forums",
      "Learning Posts",
      "Listening Posts",
    ...
    correctAnswer: "Listening Posts",
    multipleChoice: false,
  },
  {
    id: 148,
    text: "What is the minimum role required to view confidential data associated with the HR Profile?",
    options: [
      "HR Administrator [sn_hr_core.admin]",
      "Employee Service Center Admin [sn_hr_sp.admin]",
      "HR basic [sn_hr_core.basic]",
      "HR profile viewer [sn_hr_core.profile_reader]",
    ],
    correctAnswer: "HR Administrator [sn_hr_core.admin]",
    multipleChoice: false,
  },
  {
    id: 149,
    text: "Which plugin when paired with HRSD, delivers storage space, filing system, and functionality to purge and retrieve documents?",
    options: [
      "Employee Journey Management",
      "Employee Document Management",
      "Employee Document Enterprise",
      "Document Keeper",
    ],
    correctAnswer: "Employee Document Management",
    multipleChoice: false,
  },
  {
    id: 150,
  ...
  {
    id: 152,
    text: "Which HRSD application automates and streamlines employee onboarding and other activities across departments?",
    options: [
      "Lifecycle Events",
      "Employee Center",
      "HR Performance Analytics",
    ...
    correctAnswer: "Lifecycle Events",
    multipleChoice: false,
  },
  {
    id: 153,
    text: "Which Security control option uses the context of the data within the record to grant and/or restrict access?",
    options: [
    ...
    correctAnswer: "Access Control Level",
    multipleChoice: false,
  },
  {
    id: 154,
  ...
  {
    id: 155,
    text: "Which of the following features allows employees to delegate their tasks to other employees for specific date and time ranges based on delegation rules?",
    options: [
      "Role Delegation",
      "Admin Delegation",
      "Granular Delegation",
    ...
    correctAnswer: "Granular Delegation",
    multipleChoice: false,
  },
  {
    id: 156,
    ...
    correctAnswer: "Activity Field Mapping",
    multipleChoice: false,
  },
  {
    id: 157,
  ...
  {
    id: 158,
    text: "If all 'Can Edit Journey' permissions are selected on the Journey configuration, which of the following users are allowed to make changes to the existing Journey? (Choose two.)",
    options: ["The journey owner", "The employee", "The mentor", "The admin"],
    correctAnswers: ["The journey owner", "The admin"],
    multipleChoice: true,
  },
  {
    id: 159,
    text: "Which Lifecycle Event activity type enables you to manage the dependencies or order of activities within an activity set?",
    options: [
      "Approval",
      "Notification",
      "Activity container",
    ...
    correctAnswer: "Activity container",
    multipleChoice: false,
  },
  {
    id: 160,
  ...
  {
    id: 161,
    text: "All ServiceNow web traffic uses which data protocol to ensure data is always TLS encrypted in transit?",
    options: ["REST protocol", "HTTP", "SOAP protocol", "HTTPS"],
    correctAnswer: "HTTPS",
    multipleChoice: false,
  },
  {
    id: 162,
    text: "When an employee contacts HR, they speak in terms of lifecycle events. From an HR perspective, that event gets translated into several HR services that need to be performed. Of the following items, which would be considered a lifecycle event?",
    options: [
    ...
    correctAnswer: "PTO Inquiry",
    multipleChoice: false,
  },
  {
    id: 163,
    text: "The customer has a group of developers who will be tasked with making subprod updates to the HR Integrations application. Customer policy states these developers cannot be granted the System Administrator [admin] role. Which of these is the best solution for granting the appropriate access needed to complete development work in the HR application?",
    options: [
      "Grant them delegated developer role to the global application scope",
      "Advise the customer this work must be completed in Production",
      "Grant them delegated developer role only to the HR Integrations application scope",
      "Submit an exception request to allow them to have the Admin role",
    ],
    correctAnswer:
      "Grant them delegated developer role only to the HR Integrations application scope",
    multipleChoice: false,
  ...
  {
    id: 164,
    text: "Which of the following actions can be performed by an HR Administrator without the System Administrator role in ServiceNow? (Choose three.)",
    options: [
      "Add users to groups",
      "Reset user passwords",
      "Create HR Criteria",
  ...
  {
    id: 165,
    text: "Which of the following roles is required to create and manage HR Criteria?",
    options: [
      "HR Basic",
      "HR Manager",
      "HR Administrator",
    ...
    correctAnswer: "HR Administrator",
    multipleChoice: false,
  },
  {
    id: 166,
    text: "What is the purpose of Employee Center in ServiceNow HRSD?",
    options: [
      "To provide employees a self-service portal for HR inquiries and requests",
      "To manage payroll and compensation processes",
      "To handle IT-related incidents and requests",
      "To develop custom HR applications",
    ],
    correctAnswer:
      "To provide employees a self-service portal for HR inquiries and requests",
    multipleChoice: false,
  ...
  {
    id: 167,
    text: "Which HRSD module allows HR agents to manage employee relations cases confidentially?",
    options: [
      "Employee Center",
      "HR Profiles",
      "Employee Relations",
    ...
    correctAnswer: "Employee Relations",
    multipleChoice: false,
  },
  {
    id: 168,
    text: "In ServiceNow HRSD, what is the role of Lifecycle Events?",
    options: [
      "To integrate with third-party HR systems",
      "To automate complex, cross-departmental processes such as onboarding and offboarding",
      "To handle employee requests for HR assistance",
      "To manage and store employee documents",
    ],
    correctAnswer:
      "To automate complex, cross-departmental processes such as onboarding and offboarding",
    multipleChoice: false,
  ...
  {
    id: 169,
    text: "Which feature in ServiceNow HRSD is used to set up rules and conditions for granting employees access to HR services based on specific criteria?",
    options: [
      "HR Criteria",
      "Role Delegation",
      "User Authentication",
    ...
    correctAnswer: "HR Criteria",
    multipleChoice: false,
  },
  {
    id: 170,
    text: "What is the main purpose of HR Profiles in ServiceNow?",
    options: [
      "To define access permissions for HR roles",
      "To store and manage employee-specific information in a secure manner",
      "To manage time-off requests",
      "To track IT equipment assigned to employees",
    ],
    correctAnswer:
      "To store and manage employee-specific information in a secure manner",
    multipleChoice: false,
  ...
  {
    id: 171,
    text: "Which of the following is an advantage of using Scoped Applications in ServiceNow HRSD?",
    options: [
      "Improves HR case response time",
      "Enhances data security by isolating data and configurations within an application scope",
      "Allows System Administrators to view all HR data",
      "Reduces the need for HR criteria",
    ],
    correctAnswer:
      "Enhances data security by isolating data and configurations within an application scope",
    multipleChoice: false,
  ...
  {
    id: 172,
    text: "What is the function of 'Employee Document Management' in ServiceNow?",
    options: [
      "To manage employee payroll documents",
      "To store, retrieve, and purge employee documents securely",
      "To manage employee vacation requests",
      "To handle IT service requests for employees",
    ],
    correctAnswer: "To store, retrieve, and purge employee documents securely",
    multipleChoice: false,
  },
  {
    id: 173,
    text: "Which role is necessary for configuring HR Templates in ServiceNow HRSD?",
    options: [
      "HR Basic",
      "HR Manager",
      "HR Administrator",
