const ham1 = [
  ...
  {
    "id": 2,
    "text": "Which ServiceNow role enables the user to perform actions related to incident, problem, change, and configuration management?",
    "options": [
      "procurement_user",
      "inventory_admin",
      "itil",
  ...
  {
    "id": 3,
    "text": "Which plugins for asset management functionality are inactive by default? (Choose three.)",
    "options": [
      "Expense Line",
  ...
  {
    "id": 4,
    "text": "What is the third tier of the capability blueprint?",
    "options": [
  ...
  {
    "id": 5,
    "text": "Which is NOT a component of a hardware asset's lifecycle?",
    "options": [
      "Dispose",
      "Request",
      "Consume",
  ...
  {
    "id": 6,
    "text": "The Hardware Asset Management (HAM) application expands baseline ITSM Asset Management with which features? (Choose three.)",
    "options": [
  ...
  {
    "id": 7,
    "text": "Expected outcomes of IT asset management (ITAM) include which of the following? (Choose three.)",
    "options": [
      "Integrates with business services via the Service Catalog from request through to disposal",
      "Leverages IT Service Management (ITSM) to manage the lifecycle of assets as they pass through their useful life as configuration items (CIs)",
      "Provides input into, aligns with, and follows corporate governance",
      "Improves application privacy and security adherence",
      "Leverages Service Mapping to predict service impact"
    ],
    "correctAnswers": [
      "Integrates with business services via the Service Catalog from request through to disposal",
      "Leverages IT Service Management (ITSM) to manage the lifecycle of assets as they pass through their useful life as configuration items (CIs)",
  ...
  {
    "id": 8,
    "text": "What is the difference between ITAM personas and ITAM Roles? (Choose four.)",
    "options": [
      "A user may have multiple roles, but a single persona",
      "Roles control access to features in the product",
      "Personas represent types of users of the product",
      "Personas control access to features in the product",
      "Roles represent types of users of the product",
      "A user may have multiple roles and personas"
    ],
    "correctAnswers": [
      "A user may have multiple roles, but a single persona",
      "Roles control access to features in the product",
  ...
  {
    "id": 9,
    "text": "Hamm is a member of the Asset Managers group which has the ham_admin role assigned to it. Based on this role alone, which of the following operations can Hamm perform? (Choose four.)",
    "options": [
      "Revert normalization results",
      "Create and delete asset records",
      "Create purchase orders",
      "Create flows",
      "Import assets",
      "Add Service Catalog entries"
    ],
    "correctAnswers": [
      "Revert normalization results",
      "Create and delete asset records",
