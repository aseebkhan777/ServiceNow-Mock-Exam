const CSA = [
  ...
  // {
  //   id: 37,
  //   text: "Which of the following statements is true regarding import sets?",
  //   options: [
  //     "An import set can be used to move data between ServiceNow instances",
  //     "An import set can only be used to import data into ServiceNow from external systems",
  //     "An import set can be used to create records from data that exists within the same instance",
  //     "An import set can only be used to import data into ServiceNow from external systems",
  //   ],
  //   correctAnswers: [
  //     "An import set can be used to move data between ServiceNow instances",
...

  {
    ...
    options: [
      "Record Producers allow users to create records in ServiceNow through the Service Catalog",
      "Record Producers are always linked to a specific catalog item",
      "Record Producers only work with incidents",
      "Record Producers allow users to create records in the Incident form only",
    ],
    correctAnswers: [
      "Record Producers allow users to create records in ServiceNow through the Service Catalog",
    ],
...

  {
    ...
    options: ["Data Editor", "Edit Menu", "List Editor", "Form Designer"],
...

  {
    ...
    options: ["Published", "Drafted", "Retired", "Reviewed"],
...

  {
    ...
    options: ["Answer Agent", "live Feed", "Virtual Agent", "Connect Chat"],
...

  {
    ...
    options: ["report", "flow", "event", "task"],
    correctAnswers: ["task"],
    multipleChoice: false,
  },
...

  {
    ...
    options: ["Search", "Favorites", "Tags", "Bookmarks"],
    correctAnswers: ["Tags"],
    multipleChoice: false,
  },
...

  {
    ...
    options: ["Flexible", "Freeform", "Feature", "Guided boards"],
...

  {
    ...
    options: ["snc_abc", "abc", "u_abc", "sys_abc"],
...

  {
    ...
    options: ["an action", "a spoke", "a connection", "an integration step"],
  ...
  },
  {
    ...
    options: ["Batch", "Verify", "Test", "Preview"],
  ...
  },
  {
    ...
    options: ["Star", "Clock", "Application", "Funnel"],
  ...
  },
  {
    ...
    options: ["Yes/No", "True/False", "On/Off", "Binary", "0/1"],
  ...
  },
  {
    ...
    options: ["IMDB", "ITSM", "CSDM", "CMDB", "LDAP"],
    correctAnswers: ["CMDB"],
    multipleChoice: false,
  },
  {
    ...
    options: ["Coalesce Data", "Transform Data", "Import Data", "Load Data"],
  ...
  },
  {
    ...
    options: ["Database View", "Many to Many", "One to Many", "Extended"],
  ...
  },
  {
    ...
    options: ["UI Policies", "UI Settings", "UI Actions", "UI Config"],
  ...
  },
  {
    ...
    options: ["Operator", "Match Criteria", "Value", "Column", "Field"],
  ...
  },
  {
    ...
    options: ["Operator", "Filter Criteria", "Operation", "Match Criteria"],
  ...
  },
  {
    ...
    options: ["Factor", "Field", "Datapoint", "Element", "Item"],
  ...
  },
  {
    ...
    options: ["Choice", "Picker", "Drop down", "Option"],
  ...
  },
  {
    ...
    options: ["Notifications", "Alerts", "Texts", "Events", "Emails"],
  ...
  },
  {
    ...
    options: ["SQL", "Dot Walking", "Outer Join", "Joins"],
    correctAnswers: ["Dot Walking"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Match Fields", "Coalesce Fields", "Key Fields", "Sys IDs"],
  ...
  },
  {
    ...
    options: ["Access List", "Can Access", "Accessible to", "Can Read"],
  ...
  },
  {
    ...
    options: ["cmdb", "sn_cmdb_bak", "cmdb_rel_ci", "sn_cmdb", "cmdb_ci"],
  ...
  },
  {
    ...
    options: ["Module", "Content Frame", "Application Navigator", "Banner"],
  ...
  },
  {
    ...
    options: ["Categories", "Variable Sets", "Sections", "Catalog items"],
  ...
  },
  {
    ...
    options: [
      ...
      "Activate the application plugin, on your personal dev instance",
      "Activate the application plugin, on your company's production instance",
    ],
    correctAnswers: [
      "Activate the application plugin, on your personal dev instance",
    ],
  ...
  },
  {
    ...
    options: [
      "The homepage must be shared manually after moving",
      "The homepage layout will not appear on target instance",
      "The dashboard cannot be copied; it must be recreated",
      "Data sources are automatically migrated with the homepage",
    ],
  ...
  },
  {
    ...
    options: ["Transform Set", "Data Pack", "Update Set", "Import Set"],
  ...
  },
  {
    ...
    options: ["Client", "Network", "Browser", "Server"],
  ...
  },
  {
    id: 277,
    text: "On what part of the ServiceNow instance, would you find the option to Impersonate User?",
    options: ["User Menu", "Content Frame", "Application Navigator", "Module"],
  ...
  },
  {
    ...
    options: ["Type", "Properties", "Configure", "Sources", "Data"],
    correctAnswers: ["Data"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Breadcrumb", "Choice", "Menu", "Topic"],
  ...
  },
  {
    ...
    options: ["onSubmit()", "onSubmission()", "onUpdate()", "onLoad()"],
  ...
  },
  {
    ...
    options: ["high_sec_admin", "sn_acl_admin", "admin", "security_admin"],
  ...
  },
  {
    id: 300,
    text: "When moving multiple update sets at one time, what might you do to facilitate the move?",
    options: ["Preview", "Batch", "List", "Map"],
    correctAnswers: ["Batch"],
    multipleChoice: false,
  },
  {
    ...
    options: ["Preview", "Test", "Run", "Try It", "Execute"],
    correctAnswers: ["Run"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Stamp", "More Options (...)", "Pages", "Paperclip"],
    correctAnswers: ["More Options (...)"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Star", "Clock", "Triangle", "Pencil"],
    correctAnswers: ["Pencil"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Timeline", "Related List", "Activity Stream", "Audit Log"],
  ...
  },
  {
    id: 325,
    text: "What module enables an administrator to define destinations for imported data on any ServiceNow table?",
    options: ["Load Data", "Field Transform", "Schema Map", "Transform Map"],
    correctAnswers: ["Transform Map"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Context Menu", "Paper clip", "Stamp", "More options (...)"],
    correctAnswers: ["More options (...)"],
    multipleChoice: false,
  },
  {
    ...
    options: ["incident.*", "incident.all", "incident.!", "incident.None"],
  ...
  },
  {
    ...
    options: ["A filter", "A record", "A table", "A field"],
  ...
  },
  {
    ...
    options: ["Sidebar", "List Editor", "Activity formatter", "Dictionary"],
  ...
  },
  {
    ...
    options: ["service_desk", "impersonator", "admin", "incognito"],
  ...
  },
  {
    ...
    options: ["customer.none", "customer.all", "customer.field", "customer.*"],
  ...
  },
  {
    ...
    options: ["User", "Issue", "Incident", "Project", "Task", "Item"],
  ...
  },
  {
    ...
    options: ["Tags", "Formatter", "Template", "Reference type fields"],
    correctAnswers: ["Template"],
    multipleChoice: false,
  },
  {
  ...
  },
  {
    ...
    options: ["Formatter", "Dictionary", "Sidebar", "History Menu"],
