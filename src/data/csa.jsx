const CSA = [
  ...
  {
    "id": 193,
    "text": "How would you define an Access Control, to allow a user with itil role to have permission to create incident records?",
    "options": [
  ...
  {
    "id": 196,
    "text": "The ServiceNow platform supports a wide variety of plug-and-play applications. You can choose from the included workflows of build your own workflow: Which of these workflows are included in the platform? (Choose three.)",
    "options": [
      "A. Federal Workflows",
  ...
  {
    "id": 198,
    "text": "You have been asked to configure a form so an employee could order tablet and select the standard accessory options to purchase with it. These standard options are: carrying case, screen cleaner, tablet stand, and screen protector. What approach would you take? (Choose three.)",
    "options": [
  ...
  },
  {
    "id": 181,
    "text": "You are asked to create an option in the Service Catalog, which will allow a user to click 'Get Help' and describe the issue they are having. These forms should create incident records, which are automatically routed to the Service Desk. Which method would you use?",
    "options": ["A. Create Record Producer", "B. Create Catalog Item", "C. Create Order Guide", "D. Create Content Item"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
  ...
  },
  {
    "id": 183,
    "text": "Which tool graphically displays an infrastructure view for a configuration item (CI) and its relationship with other CIs?",
    "options": ["A. Schema Map", "B. Dependency View", "C. Dependency Map", "D. Database View"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    "id": 184,
    "text": "What are examples of Core tables in the ServiceNow platform?",
    "options": ["A. Configuration, Connect, Chat", "B. Team, Party, Awards", "C. User, Task, Incident", "D. Work, Caller, Timecard"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    "id": 185,
    "text": "Which tab on the knowledge base record would you use to identify the sets of users who are able to read articles in that knowledge base?",
    "options": ["A. Access List", "B. Can Access", "C. Accessible to", "D. Can Read"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    "id": 186,
    "text": "What are the main components of the Form Design interface? (Choose three.)",
    "options": ["A. Field Layout", "B. Page Header", "C. Field Navigator", "D. Field Picker", "E. Form Layout"],
    "correctAnswers": ["B", "C", "E"],
    "multipleChoice": true
  },
  {
    "id": 187,
    "text": "What is used to determine user access to knowledge bases or a knowledge article?",
    "options": ["A. sn_kb_read, sn_article_read", "B. Privacy Settings", "C. Read Access Flag", "D. User Criteria"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    "id": 188,
    "text": "What are the three key tables in an enterprise CMDB? (Choose three.)",
    "options": ["A. cmdb", "B. sn_cmdb_bak", "C. cmdb_rel_ci", "D. sn_cmdb", "E. cmdb_ci"],
    "correctAnswers": ["A", "C", "E"],
    "multipleChoice": true
  },
  {
  ...
  },
  {
    "id": 191,
    "text": "Which application is used primarily to load data into ServiceNow?",
    "options": ["A. Import Hub", "B. System Import Sets", "C. Data Import Configuration", "D. Import Management"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    "id": 192,
    "text": "If a knowledge base has no access details specified, what users are able to read articles in that knowledge base?",
    "options": ["A. itil users", "B. Any user with an article's permalink", "C. Any active user", "D. No users", "E. Users with kb_user role"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
  ...
  },
  {
    "id": 194,
    "text": "What Service Catalog feature do you use to organize items into logical groups?",
    "options": ["A. Categories", "B. Variable Sets", "C. Sections", "D. Catalog items"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
...

  {
    "id": 201,
    "text": "On the Reports page, what sections allow you to see which reports are visible to different audiences? (Choose four.)",
    "options": ["A. Group", "B. Department", "C. My reports", "D. Team", "E. Global", "F. All"],
  ...
  },
  {
    ...
    "options": ["A. Label", "B. Column", "C. Data Element", "D. Field", "E. Attribute"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    "id": 203,
    "text": "You have been asked to create a way for users to order a new iPhone, but only if they get two levels of approval. The approvers and users should be automatically notified at each approval level. What feature would you use to manage the approvals and notifications?",
    "options": ["A. Approval Chains", "B. Flows", "C. Approver Delegates", "D. Parent-Child Approvers", "E. Approval Criteria"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. User Group [user_groups]", "B. Groups [sys_user_groups]", "C. Group [sn_sys_user_group]", "D. Group [sys_user_group]", "E. User Groups [sn_user_groups]"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Groups and Users", "B. Me", "C. Roles and Permissions", "D. Everyone", "E. Admins"],
    "correctAnswers": ["A", "B", "D"],
    "multipleChoice": true
  },
  {
    ...
    "options": ["A. Field Transform", "B. Schema Map", "C. Transform Map", "D. Import Map"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Preparation", "B. Containment, Eradication, Recovery", "C. Detection & Analysis", "D. Auditing & Logging", "E. Post-mortem"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Plus, Minus", "B. Ctrl <, Ctrl >", "C. Arrows", "D. Ctrl C, Ctrl V", "E. Shift F4, Shift F5"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Field-level - most specific to most general; then Table-level - most specific to most general", "B. Field-level - most general to most specific; then Row-level - most specific to most general", "C. Table-level - most specific to most general; then Field-level - most specific to most general", "D. Table-level - most specific to most general, then Row-level - most specific to most general"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Docs", "B. Community", "C. Help Panel (Q mark icon)", "D. Wiki"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
...

  {
    ...
    "options": ["A. Style", "B. Group by", "C. Configure", "D. Format", "E. Data"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Clock", "B. Pencil", "C. Triangle", "D. Star"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Search the wiki for the sales demo request form", "B. Check the latest release notes at docs.servicenow.com", "C. Activate the application plugin, on your personal dev instance", "D. Activate the application plugin, on your company's production instance"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. On the Category column header, right click and select Show > Hardware", "B. Right click on magnifier, type Hardware and click enter", "C. On the list, locate and right click on the value Hardware, select Show Matching", "D. On Breadcrumb, click > icon, type Hardware and click enter", "E. Click Funnel icon, type Hardware and click enter"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Click List Magnifier to expand column search, on Short Description, type email, click enter", "B. On Search box, select text, type email, click enter", "C. Click List Magnifier to expand column search, on Short Description, type *email, click enter", "D. Click List Magnifier to expand column search, on Short Description, type %email, click enter"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Run Data Scrubber", "B. Set Coalesce", "C. Select Import Set", "D. Load Data", "E. Define Data Source"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Vendors can sell multiple products; and products can be sold by multiple vendors.", "B. A Task can trigger many Workflows; and a Workflow can trigger many Tasks.", "C. Requests can contain many Items; and Items can be any item from the catalog.", "D. A Configuration Item can belong to multiple Classes, and Classes can contain multiple Configuration Items."],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Audit Log", "B. Timeline", "C. Activity", "D. Journal"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Create Requested Item", "B. Create Record Producer", "C. Create On-boarding Bot", "D. Create Order Guide"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Automapping Utility", "B. Relationships", "C. Service Tracer", "D. Transform Map"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
...

  {
    ...
    "options": ["A. Gear", "B. Context Menu", "C. Pencil", "D. Magnifier"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. C++", "B. JavaScript", "C. PHP", "D. Python"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. List Links", "B. List Choices", "C. List Buttons", "D. List Override", "E. List Context Menu", "F. List Control"],
  ...
  },
  {
    ...
    "options": ["A. Create a Variable Set Template, then apply to all of the catalog items.", "B. Create one Variable Set for the four variables, then add that variable set to each of the 80 catalog items.", "C. Create a Record Producer that contains the four fields; then add to the record producer related list on the Catalog Items.", "D. Create a Flow Designer Action, with Variable Set Data Pill, then apply flow to all of the 80 catalog items.", "E. Create an Order Guide, which includes all variables; then copy and hide variables as needed."],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. On My Work list, select the Activity Stream icon to show a frame with live updates", "B. Click on the eyeglass icon to expand the Monitor frame", "C. Open an Agent workspace tab for each record he wants to monitor", "D. Select Service Desk > My Work Dashboard"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. sn_knowledge_import", "B. sn_knowledge_contribute", "C. Can contribute", "D. Can import"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Schedule Transform", "B. Field Matching", "C. Select Data Source", "D. Create Transform Map", "E. Load Data"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Global", "B. Reverse if false", "C. On load", "D. Inherit"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Select source file; Run automap; Transform data; Clean up target table", "B. Identity source; Import transform map; Run transformer, Verify import", "C. Setup LDAP; Test map; Create update set; Run import; Apply update set", "D. Load the data; Create transform map; Transform data; Clean up import table"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Script Include Scripts", "B. Access Control Scripts", "C. Business Rule Scripts", "D. UI Policies and Client Scripts"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
...

  {
    ...
    "options": ["A. Dictionary", "B. Schema Map", "C. Tables", "D. Tables & Columns"],
    "correctAnswers": ["C", "D"],
    "multipleChoice": true
  },
  {
    ...
    "options": ["A. Create, Read, Upload, Delete", "B. Capture, Rate, Write, Develop", "C. Create, Rate, Update, Delete", "D. Create, Read, Write, Delete"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. A user is a record stored in the Profile [sys_user_profile] table", "B. A user is a record stored in the User [sys_user] table", "C. A user is a record stored in the User Preference [sys_user_preference] table", "D. A user is a field in the LDAP integration"],
    "correctAnswers": ["B"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. CI Dependency View", "B. Event Management Homepage", "C. Service Dashboard", "D. CI Health Dashboard"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Flow Designer", "B. Workflow Editor", "C. Process Workflow Designer", "D. Process Automation Designer"],
    "correctAnswers": ["D"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Their user account does not have itil role", "B. Their user account was not approved by their manager", "C. Their user account is not logged in properly", "D. Their user account failed LDAP authentication", "E. Their user account does not belong to any groups, which contain the itil role"],
    "correctAnswers": ["A", "E"],
    "multipleChoice": true
  },
  {
    ...
    "options": ["A. Add", "B. Edit", "C. Publish", "D. Manage", "E. New"],
  ...
  },
  {
    "id": 238,
    "text": "A customer requests the following data quality measures be added:\n• Incident numbers should be read only, on all lists and forms, for all users.\n• Short Description field should be mandatory, on all records, across all applications, on Insert.\nWhich type of policy would you use to meet this requirement?",
    "options": ["A. Data Quality Policy", "B. Dictionary Design Policy", "C. Data Policy", "D. Field Criteria Policy"],
    "correctAnswers": ["C"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Application Navigator", "B. Service Desk Homepage", "C. Self Service Module", "D. Favorites"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
    ...
    "options": ["A. Catalog Builder", "B. Workflow Designer", "C. Catalog Designer", "D. Catalog Formatter"],
    "correctAnswers": ["A"],
    "multipleChoice": false
  },
  {
